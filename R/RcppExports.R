...
WH_pchisq <- function(x, df) {
    .Call(`_WHcircular_WH_pchisq`, x, df)
}
...
#' @examples
#' library(WH_circular)
#' y <- WH_HHMM_to_rad(c("23:00","23:15","23:30","23:45","00:00",
#'                     "01:00","01:15","01:30","01:45","02:00"))
#' print(WH_rad_to_HHMM(WH_mean_rad(y)))
#' @export
...
WH_select_bool <- function(input, mask) {
    .Call(`_WHcircular_WH_select_bool`, input, mask)
}

WH_selectrow_bool <- function(input, mask) {
    .Call(`_WHcircular_WH_selectrow_bool`, input, mask)
}
